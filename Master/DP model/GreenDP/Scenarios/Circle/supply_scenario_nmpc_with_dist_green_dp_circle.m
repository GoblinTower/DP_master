...
% Output files
folder = "Results/nmpc_green_dp_dist_circle";             % Name of folder to store output files
file_prefix = "nmpc_green_dp_dist_circle_";               % Prefix of file names
workspace_file_name = "nmpc_green_dp_dist_circle_data";   % File name of .mat file
