...
% Output files
folder = "Results/lq_trajectory_tracking_without_dist";                    % Name of folder to store output files
file_prefix = "lq_trajectory_tracking_without_dist_";                      % Prefix of file names
workspace_file_name = 'lq_trajectory_tracking_without_dist_data.mat';      % Name of workspace file
...
Q = diag([1e9, 1e9, 1e11]);          % Error weighting matrix
P = 1.0*eye(3);                      % Input weighting matrix
