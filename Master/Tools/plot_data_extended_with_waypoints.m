function [iae, tv] = plot_data_extended_with_waypoints(lmf, nos, show_setpoints, font_size, folder, details, show_current_estimate, large_plots)
...
for i=1:number_of_simulations
    ...
    plot(lmf(i).waypoints(2,:), lmf(i).waypoints(1,:), 'bx', 'MarkerSize', 10, 'LineWidth', 3);     % End waypoints
    grid();
    ...
    legend({'Path', 'Start position', 'End position', 'Waypoints'}, 'Location', 'northwest');
    grid on, grid minor;
    box on;
    hold off;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Velocity and angular moment in BODY frame %%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
