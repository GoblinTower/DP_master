function plot_nmpc_simple_tracking(t, x, x_est, K, u, wind_abs, wind_beta, wind_force, current_force, wave_force, setpoint, waypoint, save_plots, folder, file_prefix)
