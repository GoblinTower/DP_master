function plot_supply_linear_mpc_r_constant(t, x, x_est, K, u, wind_abs, wind_beta, wind_force, current_force, wave_force, setpoint, save_plots)
    ...
    if (save_plots)
        save_plot(f1, "mpc_states", "Results/MPC_r_const");
        save_plot(f2, "mpc_path", "Results/MPC_r_const");
        save_plot(f3, "mpc_inputs", "Results/MPC_r_const");
        save_plot(f5, "mpc_wind", "Results/MPC_r_const");
        save_plot(f6, "mpc_current", "Results/MPC_r_const");
        save_plot(f6, "mpc_wave", "Results/MPC_r_const");
    end
