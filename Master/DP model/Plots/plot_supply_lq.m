function plot_supply_lq(t, x, x_lin, K, u, setpoint)
    ...
    xlabel('t [s]');
    ylabel('North, x [m]');
    legend({'Process', 'Linear model', 'Setpoint'}, 'Location', 'Best');
    hold off
    ...
    xlabel('t [s]');
    ylabel('x [m]');
    legend({'Real', 'Linear model'}, 'Location', 'Best');
    hold off
