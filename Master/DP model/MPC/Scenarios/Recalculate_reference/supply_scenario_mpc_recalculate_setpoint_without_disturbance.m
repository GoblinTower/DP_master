...
% Output files
folder = "Results/mpc_recalculate_setpoint_du_no_dist";         % Name of folder to store output files
file_prefix = "mpc_recalculate_setpoint_du_no_dist";            % Prefix of file names
