...
run 'Scenarios\supply_scenario_LQ_control_tracking';
...
% Plot data
plot_supply_lq_no_disturbance_tracking(t_array, x_array, K_array, u_array, setpoint_array, waypoints, true);
