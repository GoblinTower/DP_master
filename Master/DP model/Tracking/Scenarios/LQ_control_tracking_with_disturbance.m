...
% Output files
folder = "Results/lq_trajectory_tracking_with_dist";                    % Name of folder to store output files
file_prefix = "lq_trajectory_tracking_with_dist_";                      % Prefix of file names
workspace_file_name = 'lq_trajectory_tracking_with_dist_data.mat';      % Name of workspace file
