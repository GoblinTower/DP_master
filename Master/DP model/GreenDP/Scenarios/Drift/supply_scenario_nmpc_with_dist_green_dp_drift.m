...
% Output files
folder = "Results/nmpc_green_dp_dist_drift";             % Name of folder to store output files
file_prefix = "nmpc_green_dp_dist_drift_";               % Prefix of file names
workspace_file_name = "nmpc_green_dp_dist_drift_data";   % File name of .mat file
