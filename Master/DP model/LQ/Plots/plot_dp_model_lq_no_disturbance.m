function plot_dp_model_lq_no_disturbance(t, x, x_est, K, u, wind_abs, wind_beta, wind_force, current_force, wave_force, setpoint, save_plots)
    ...
    if (save_plots)
        save_plot(f1, "lq_no_dist_states", "Results/dp_LQ_no_dist");
        save_plot(f2, "lq_no_dist_path", "Results/dp_LQ_no_dist");
        save_plot(f3, "lq_no_dist_inputs", "Results/dp_LQ_no_dist");
        save_plot(f5, "lq_no_dist_wind", "Results/dp_LQ_no_dist");
        save_plot(f6, "lq_no_dist_current", "Results/dp_LQ_no_dist");
        save_plot(f6, "lq_no_dist_wave", "Results/dp_LQ_no_dist");
    end
