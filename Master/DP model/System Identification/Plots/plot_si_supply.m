function [iae, tv] = plot_data_extended(lmf, nos, show_setpoints, font_size, folder, details, show_current_estimate, plot_number_environmental)
...
if (show_current_estimate)
    plot(lmf(plot_number_environmental).t_array(1:length_time), lmf(plot_number_environmental).x_est_array(10,1:length_time));
end
grid();
...
if (show_current_estimate)
    plot(lmf(plot_number_environmental).t_array(1:length_time), lmf(plot_number_environmental).x_est_array(11,1:length_time));
end
grid();
