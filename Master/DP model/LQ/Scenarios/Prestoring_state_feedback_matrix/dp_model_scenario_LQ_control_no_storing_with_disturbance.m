...
% Output files
folder = "Results/lq_dp_model_no_stored_matrices_dist";              % Name of folder to store output files
file_prefix = "lq_dp_model_no_stored_matrices_dist_";                % Prefix of file names
workspace_file_name = 'lq_dp_model_no_stored_matrices_dist_data';    % Name of workspace file
...
%%% Prestored matrices %%%
%%%%%%%%%%%%%%%%%%%%%%%%%%
run_using_stored_matrices = false;
