...
run 'Scenarios\supply_scenario_mpc_control_r_const';
...
% Plot data
plot_supply_linear_mpc_r_constant(t_array, x_array, x_est_array, K_array, u_array, wind_abs, wind_beta, wind_force_array, current_force, wave_force, setpoint, true);
