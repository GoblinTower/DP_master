...
% Output files
folder = strcat("Results/nmpc_mc_no_green_dp_dist_", num2str(mc_iteration));                         % Name of folder to store output files
file_prefix = "nmpc_mc_no_green_dp_dist_";                                                           % Prefix of file names
workspace_file_name = strcat("/Monte_Carlo/nmpc_mc_no_green_dp_dist_data_", num2str(mc_iteration));  % File name of .mat file
