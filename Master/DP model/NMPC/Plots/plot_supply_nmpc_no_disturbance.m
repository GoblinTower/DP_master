function plot_supply_nmpc_no_disturbance(t, x, K, u, setpoint, save_plots)
    ...
    if (save_plots)
        save_plot(f1, "nmpc_no_dist_states", "Results/nmpc_no_dist");
        save_plot(f2, "nmpc_no_dist_path", "Results/nmpc_no_dist");
        save_plot(f3, "nmpc_no_dist_inputs", "Results/nmpc_no_dist");
    end
