function plot_supply_linear_mpc_r_constant(t, x, K, u, setpoint, save_plots)
    ...
    if (save_plots)
        save_plot(f1, "mpc_states", "Results/MPC_r_constant");
        save_plot(f2, "mpc_path", "Results/MPC_r_constant");
        save_plot(f3, "mpc_inputs", "Results/MPC_r_constant");
    end
