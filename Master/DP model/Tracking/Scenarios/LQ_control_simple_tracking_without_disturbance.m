...
% Output files
folder = "Results/simple_tracking_lq_no_dist";        % Name of folder to store output files
file_prefix = "lq_no_dist_simple_tracking_";          % Prefix of file names

% LQ control parameters
Q = diag([1e9, 1e9, 1e12]);          % State weighting matrix
