function [A_lin, B_lin, F_lin, C_lin] = dp_model_discrete_matrices_si_int_identity(A_si, B_si, C_si, psi, dt)
...
% Transition matrix
A_lin = [
            eye(3), dt*rotation, zeros(3,3);
            zeros(n_dim,3), A_si, B_si*rotation';
            zeros(3,3), zeros(3,3), zeros(3,3)
        ];

% Input matrix
B_lin = [zeros(3,r_dim); B_si; zeros(3,3)];

% Disturbance input matrix
F_lin = [zeros(3,r_dim); B_si; zeros(3,3)];

% Output matrix
C_lin = [eye(3), zeros(3,n_dim), zeros(3,3)];
