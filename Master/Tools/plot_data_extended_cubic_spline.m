function [iae, tv] = plot_data_extended_cubic_spline(lmf, nos, show_setpoints, font_size, folder, details, show_current_estimate, plot_number_environmental)
...
for i=1:number_of_simulations
    ...
    legend({'Path', 'Start position', "End position", "Waypoints"}, 'Location', 'northeast');
    grid on, grid minor;
    box on;
    hold off;
