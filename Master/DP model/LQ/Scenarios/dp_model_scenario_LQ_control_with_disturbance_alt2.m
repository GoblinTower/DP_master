...
% Output files
folder = "Results/lq_dp_model_dist_alt2";                % Name of folder to store output files
file_prefix = "lq_dp_model_dist_alt2_";                  % Prefix of file names
workspace_file_name = 'lq_dp_model_dist_alt2_data';      % Name of workspace file
...
W_noise = diag([1e2, 1e2, 1e2, 1e2, 1e2, 1e2, 1e12, 1e12, 0.8e14]);   % Process noise
V_noise = diag([10, 10, 10]);                                       % Measurement noise
