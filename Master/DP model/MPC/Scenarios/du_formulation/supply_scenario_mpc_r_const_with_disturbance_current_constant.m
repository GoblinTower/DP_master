...
% Output files
folder = "Results/mpc_const_r_du_with_dist_current_const";                   % Name of folder to store output files
file_prefix = "mpc_const_r_du_with_dist_current_const_";                     % Prefix of file names
workspace_file_name = "mpc_const_r_du_with_dist_current_const.mat";          % Name of .mat file
...
run 'common_external_disturbances_constant_current.m';
