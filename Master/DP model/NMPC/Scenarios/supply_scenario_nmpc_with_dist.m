...
% Output files
folder = "Results/nmpc_dist";                   % Name of folder to store output files
file_prefix = "nmpc_dist_";                     % Prefix of file names
workspace_file_name = 'nmpc_dist_data';         % Name of workspace file
