function plot_supply_lq_alloc_2_tunnel(t, x, x_est, K, u, wind_abs, wind_beta, wind_force, current_force, wave_force, rpm, f, setpoint, save_plots, folder, file_prefix)
...
f1 = figure(1); % Plotting states
    ...
    grid();
    title('Force aft tunnel thruster');
    xlabel('t [s]');
    ylabel('Force [m]');
