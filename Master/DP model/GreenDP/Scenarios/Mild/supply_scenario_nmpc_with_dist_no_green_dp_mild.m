...
% Output files
folder = "Results/nmpc_no_green_dp_dist_mild";                % Name of folder to store output files
file_prefix = "nmpc_no_green_dp_dist_mild_";                  % Prefix of file names
workspace_file_name = "nmpc_no_green_dp_dist_mild_data";      % File name of .mat file
