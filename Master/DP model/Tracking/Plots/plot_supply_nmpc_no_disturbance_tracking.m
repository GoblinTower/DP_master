function plot_supply_nmpc_no_disturbance_tracking(t, x, K, u, setpoint, waypoints, save_plots)
    ...
    if (save_plots)
        save_plot(f1, "nmpc_no_dist_tracking_states", "Results/nmpc_no_dist_tracking");
        save_plot(f2, "nmpc_no_dist_tracking_path", "Results/nmpc_no_dist_tracking");
        save_plot(f3, "nmpc_no_dist_tracking_inputs", "Results/nmpc_no_dist_tracking");
    end
