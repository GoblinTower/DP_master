function plot_supply_lq_linearized(t, x, K, u, setpoint, save_plots)
    ...
    if (save_plots)
        save_plot(f1, "lq_linearized_states", "Results");
        save_plot(f2, "lq_linearized_path", "Results");
        save_plot(f3, "lq_linearized_inputs", "Results");
    end
