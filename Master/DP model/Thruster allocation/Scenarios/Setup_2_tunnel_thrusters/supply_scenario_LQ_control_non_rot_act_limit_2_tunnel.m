...
% Output files
folder = "Results/lq_nonrot_2tunnel_dist_limit";                % Name of folder to store output files
file_prefix = "lq_nonrot_2tunnel_dist_limit_";                  % Prefix of file names
workspace_file_name = 'lq_nonrot_2tunnel_dist_limit_data';      % Name of workspace file
